...
INSERT INTO personaje VALUES (1,'Bruce Banner','Hulk',160,600.000,75,98,1962,'Fisico Nuclear',1);
INSERT INTO personaje VALUES (2,'Tony Stark','Iron Man',170,200.000,70,123,1963,'Inventor Industrial',1);
INSERT INTO personaje VALUES (3,'Thor Odinson','Thor',145,999999,100,235,1962,'Rey de Asgard',1);
...
INSERT INTO personajes (id_personaje, nombre_real, personaje,
 ...
 -- elimine por id de personaje porque cuando quiero preguntar por el personaje no me ejecuta la query
-- el problema es que tenia activado el SAFE UPDATE EN PREFERENCES

DELETE FROM personaje WHERE id_personaje = 5;

UPDATE personaje SET aparicion='1938' WHERE ocupacion='Reportero'; 
